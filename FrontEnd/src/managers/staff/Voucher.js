...
function Voucher() {
    ...
    const handleSaveVoucher = (updatedVoucher) => {
        fetch(`http://localhost:5000/api/v1/voucher/updateVoucher/${updatedVoucher.VoucherID}`, {
            method: 'PUT',
            headers: {
                        ...
                        <table>
                            <thead>
                                <tr>
                                    <th>
                                        Voucher Name
                                        <button onClick={() => handleSort('VoucherName')}>↕</button>
                                    </th>
                                    <th>
                                        Quantity
                                        <button onClick={() => handleSort('Quantity')}>↕</button>
                                    </th>
                                    <th>
                                        Discount Percentage
                                        <button onClick={() => handleSort('DiscountPercentage')}>↕</button>
                                    </th>
                                    <th>
                                        Min Discount
                                        <button onClick={() => handleSort('MinDiscount')}>↕</button>
                                    </th>
                                    <th>
                                        Max Discount
                                        <button onClick={() => handleSort('MaxDiscount')}>↕</button>
                                    </th>
                                    <th>
                                        Start Date
                                        <button onClick={() => handleSort('StartDate')}>↕</button>
                                    </th>
                                    <th>
                                        Expiry Date
                                        <button onClick={() => handleSort('ExpiryDate')}>↕</button>
                                    </th>
                                    <th>
                                        Status
                            ...
                            <tbody>
                                {filteredVouchers.map(voucher => (
                                    <tr key={voucher.VoucherID}>
                                        ...
                                        <td>
                                            <button onClick={() => handleEditClick(voucher)}>Edit</button>
                                        </td>
                                    </tr>
                                ))}
                            </tbody>
