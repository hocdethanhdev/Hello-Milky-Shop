...
const LanguageSelector: React.FC<LanguageSelectorProps> = () => {
  ...
  return (
    <div className="relative inline-flex flex-row-reverse" ref={dropdownRef}>
      <button
        className="py-2 px-4 inline-flex items-center gap-2 font-semibold text-white bg-blue-500 rounded-lg hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-400 w-28 mr-2"
        onClick={toggleMenu}
      >
